...
df1=pd.read_csv("/Capstone_1/중소기업은행_금융용어 해설.csv", encoding='euc-kr')
df2=pd.read_csv("/Capstone_1/한국산업은행_금융 관련 용어.csv", encoding='euc-kr')
df3=pd.read_csv("/Capstone_1/한국자산관리공사_공사홈페이지_용어사전.csv", encoding='utf-8')
